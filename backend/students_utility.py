...
def display_notification(title, message, flag, display_duration_in_ms=10000, use_fade_in=True, alpha=0.9, location=None):
    """
    ...
    win_location = location if location is not None else ((screen_res_x*0.65) - win_width - win_margin, (screen_res_y*0.60) - win_height - win_margin)
...
# display_notification("Add student Failed", "Failed to add", "Fail", 200, use_fade_in=True)

# if __name__ == '__main__':
#     title = "Action completed successfully"
#     message = "Database created with admin as Hillary Mapondera"
#     flag = "success"
#     display_notification(title, message, flag, 1500, use_fade_in=True)